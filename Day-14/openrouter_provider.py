"""
Day 14 - OpenRouter Provider for MCP Implementation
Custom provider to enable OpenRouter API integration with OpenAI client for MCP.
"""
...
class OpenRouterProvider:
    ...
    def __init__(self, api_key: str, base_url: str, model_name: str):
        ...
        self.client = OpenAI(
            api_key=api_key,
            base_url=base_url,
            default_headers={"HTTP-Referer": "http://localhost:3000", "X-Title": "Day 14 - MCP Implementation"},
        )
